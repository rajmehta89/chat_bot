...
Please provide a helpful response. If the question is about a PDF and no PDF content is available, let the user know they need to upload a PDF first."""
        else:
        ...
        prompt = f"""You are a helpful PDF assistant. Answer the question based on the PDF content and our conversation history.
